...
?>
            ...
            <div id="boton">&nbsp;</div>
            <div id="checkbox_1"><input type="checkbox" id="checkbox" name="checkbox" onclick="habilitaDeshabilita(this.form);" value="checkbox" tabindex="4" id="soynuevo" ><label for="soynuevo">I'm new</label></div>
		</div>
